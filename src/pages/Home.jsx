        ...
        <div>
                ...
                <div class="container py-5">
                    <div class="row g-5">
                        <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.1s">
                            ...
                            <h1 class="display-4 text-white" ><CountUp end={1234} enableScrollSpy /></h1>
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    ...
                    <div class="row g-4">
                        <Teamcard name='Kate Winslet' image="img/team-1.jpg" />
                        <Teamcard name='Jac Jacson' image="img/team-2.jpg" />
                        <Teamcard name='Doris Jordan' image="img/team-3.jpg" />
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    ...
                    <div class=" testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                        <Homeslider />
                    </div>
                </div>
            </div>
